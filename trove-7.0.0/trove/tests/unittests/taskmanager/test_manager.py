...
class TestManager(trove_testtools.TestCase):
    ...
    def test_create_replication_subordinate(self, mock_load, mock_backup_delete):
        mock_tasks = Mock()
    ...
    @patch.object(models.BuiltInstanceTasks, 'load')
    @patch('trove.taskmanager.manager.LOG')
    def test_exception_create_replication_subordinate(self, mock_logging, mock_tasks,
        ...
        self.assertRaises(TroveError, self.manager.create_instance,
                          ...
                          Mock(), 'some-main-id', None, None, None, None)
